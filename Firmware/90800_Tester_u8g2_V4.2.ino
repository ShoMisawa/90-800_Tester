...
void loop() {
  ...
  // in_voltage = (adc_voltage / resRatio) + SCHOTTKY_VOLTAGE_DROP; // SCHOTTKY_VOLTAGE_DROP is for schottky diode voltage adjustment

  // // J4 on the tester PWA
  // adc_value_2 = analogRead(1);
  // adc_voltage_2 = (adc_value_2 * ref_voltage) / 4095.0;
  // in_voltage_2 = (adc_voltage_2 / resRatio) + SCHOTTKY_VOLTAGE_DROP; // SCHOTTKY_VOLTAGE_DROP is for schottky diode voltage adjustment
